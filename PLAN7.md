...
| E30 | Fidelity entry **30**: the `_e8` reading, and "dev and sealed agree within 0.3" | accept | J1a as in F3. The earlier agreement is 0.3 **to 1.3**: deep8_300 reads 83.5 on `endgame_v2_dev` (KNOWLEDGE `:673`) against 84.8 [83.5, 86.0] sealed (KNOWLEDGE 30, which says "within 0.3 / 1.3") | map row 30 and the outline's §6 line |
